...
-- Insert table users
-- -----------------------------------------------------
INSERT INTO users (id, first_name, last_name, date_of_birth, identity_passport_number, email, password, gender, role)
...
-- -----------------------------------------------------
INSERT INTO account (id, user_id, nick_name, password, phone_number)
